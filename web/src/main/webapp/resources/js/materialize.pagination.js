    ...
    MaterializePagination.prototype = {
        ...
        createPaginationBase: function(requestedPage) {
            ...
            if (this.currentPage !== 0) {
                this.$container.append($prevChevron);
            }
            ...
            if (this.currentPage < this.config.lastPage - 1) {
                this.$container.append($nextChevron);
            }
        ...
        requestPage: function(requestedPage, initing) {
            ...
            if (this.config.useUrlParameter)
                this.updatedUri = this.updateUrlParam(this.config.urlParameter, this.currentPage);
            if (!initing)
                this.config.onClickCallback(this.currentPage, this.updatedUri);
            this.renderActivePage();
        },
